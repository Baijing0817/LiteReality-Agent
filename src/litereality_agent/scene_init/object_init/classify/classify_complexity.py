...
Run (from repo root):
    python -m litereality_agent.scene_init.object_init.classify.classify_complexity                       # all scans
    python -m litereality_agent.scene_init.object_init.classify.classify_complexity --scan tea_room
"""
