...
Run (from the repo root):
    python -m litereality_agent.scene_init.object_init.run --scan office-elliott
    python -m litereality_agent.scene_init.object_init.run --scan office-elliott --skip-gemini
    python -m litereality_agent.scene_init.object_init.run --scan /abs/path/to/raw_scan --name my_room
    python -m litereality_agent.scene_init.object_init.run --scan office-elliott --reconstruct
...
from . import config, merge_boxes, reconstruct, tracing
from .classify import classify_complexity
from .crop import crop_objects
from .detect import bbox_polish
from .extract import extract_scene
from .qc import chair_qc
from .references import chair_clusters, object_references, opening_references
