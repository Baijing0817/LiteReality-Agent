...
each has a caveat worth reading (see ``--help`` and the notes below).
    ...
    python scripts/shrink_scan.py <scan> --dry-run
    python scripts/shrink_scan.py <scan> --quality 80
    python scripts/shrink_scan.py <scan> --quality 80 --long-edge 1024 --extras
