...
Needs a compiled `Room.glb` (build the room first) and `python-fcl`.
    ...
    python -m litereality_agent.scene.quality.correct --room <dir>          # dry run: print the plan
    python -m litereality_agent.scene.quality.correct --room <dir> --apply  # write the nudges into Room.py
"""
