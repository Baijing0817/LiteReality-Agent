...
Rebuild with `python -m litereality_agent.scene.compile.build_from_room --room Room/<scan>`.

    python -m litereality_agent.scene.export.export_room --scan office-elliott
"""
        ...
        if a["source"] == "procedural":
            ...
            if tex.is_dir() and any(tex.iterdir()):
                try:
                    ...
                    from litereality_agent.scene.compile.texture_recipe import (
