...
stage. The three layers:
  ...
  python -m litereality_agent.scene.rendering.image_selection.select_references <scan> \
...
SELECT_VIEWS = PACKAGE_ROOT / "scene" / "rendering" / "room_render" / "select_views.py"
