"""litereality_agent.services.tools — the capability tools handed to the authoring/materials/QC
agent. See README.md.
...
from litereality_agent.services.tools.default_registry import build_default_registry
