...
CLI:  python -m litereality_agent.services.rendering.engine <frames|surface> --room <room dir> [...]
API:  from litereality_agent.services.rendering.engine import render_frames, render_surface
"""
...
def render_wall_reference(
    ...
    *,
    ...
    from litereality_agent.services.rendering import surface_compare
    ...
    if with_refs:
        from litereality_agent.services.rendering import wall_refs
