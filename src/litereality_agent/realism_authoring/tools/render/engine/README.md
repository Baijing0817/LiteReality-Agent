...
>
> ```python
> from litereality_agent.realism_authoring.tools.render.engine.compose import _config_for, _scan_from_room
> from litereality_agent.realism_authoring.tools.render.engine import _overlay
...
```python
from litereality_agent.realism_authoring.tools.render.engine import render_frames, render_surface

room = "run/<scan>/scene_init/scene_stage/stage_2/iteration_2/room"

from litereality_agent.realism_authoring.tools.render.engine import (
...
```bash
python -m litereality_agent.realism_authoring.tools.render.engine scene  --room <room> --frames 10,20,30
python -m litereality_agent.realism_authoring.tools.render.engine wall   --room <room> --frames 10,20
python -m litereality_agent.realism_authoring.tools.render.engine wall-focus --room <room> --frames 34,35 --wall Wall2
python -m litereality_agent.realism_authoring.tools.render.engine object --room <room> --frames 10 --object Table0
python -m litereality_agent.realism_authoring.tools.render.engine ref    --room <room> --walls Wall0,Wall2
python -m litereality_agent.realism_authoring.tools.render.engine ref    --room <room>                # all walls
```
...
|---|---|---|
| **all layers** | `<room>/Room.py` | `uv run -m litereality_agent scene_init` → scene_init (the room definition) |
