"""CLI for the image-render-tool — four modes.
  ...
  python -m litereality_agent.realism_authoring.tools.render.engine scene  --room R --frames 10,20        # all objects
  python -m litereality_agent.realism_authoring.tools.render.engine wall   --room R --frames 10,20        # walls only
  python -m litereality_agent.realism_authoring.tools.render.engine wall-focus --room R --frames 10 --wall Wall2   # ONE wall
  python -m litereality_agent.realism_authoring.tools.render.engine object --room R --frames 10 --object Table0

  # wall reference (ortho render | stitch + wall-focused ref frames):
  python -m litereality_agent.realism_authoring.tools.render.engine ref    --room R --walls Wall0,Wall2
"""
