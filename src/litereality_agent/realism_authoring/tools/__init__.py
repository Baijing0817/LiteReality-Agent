"""litereality_agent.realism_authoring.tools — the capability tools handed to the authoring/materials/QC
agent. See README.md.
...
from litereality_agent.realism_authoring.tools.default_registry import build_default_registry
