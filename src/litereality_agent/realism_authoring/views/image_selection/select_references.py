...
stage. The three layers:
  ...
  python -m litereality_agent.realism_authoring.views.image_selection.select_references <scan> \
...
SELECT_VIEWS = PACKAGE_ROOT / "realism_authoring" / "views" / "room_render" / "select_views.py"
