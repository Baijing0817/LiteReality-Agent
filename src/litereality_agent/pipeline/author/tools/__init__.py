"""litereality_agent.pipeline.author.tools — the capability tools handed to the authoring/materials/QC
agent. See README.md.
...
from litereality_agent.pipeline.author.tools.default_registry import build_default_registry
