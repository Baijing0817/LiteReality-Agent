...
Run (from repo root):
    python -m litereality_agent.pipeline.reconstruct.classify.classify_complexity                       # all scans
    python -m litereality_agent.pipeline.reconstruct.classify.classify_complexity --scan tea_room
"""
...
from litereality_agent.models import classification
