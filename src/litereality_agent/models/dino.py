...
from litereality_agent.models.base import Detection
...
class DinoSubprocessService:
    ...
    def __init__(
        ...
        *,
        ...
        self.command = command or [self.python, "-u", "-m", "litereality_agent.scene_init.object_init.detect.dino_worker"]
