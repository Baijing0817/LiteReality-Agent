...
The local application sends images as base64 and receives JSON only. Torch and model weights stay
inside the worker image. Configure the deployed endpoint with:
