...
class LiteRealitySettings(BaseSettings):
    ...
    provider: str = Field(default="claude_cli", validation_alias="LR_PROVIDER")
    ...
    sketchfab_api_token: SecretStr | None = Field(
        default=None, validation_alias="SKETCHFAB_API_TOKEN"
    )
    ...
    def as_environment(self) -> dict[str, str]:
        ...
        secrets = {
            ...
            "SKETCHFAB_API_TOKEN": self.sketchfab_api_token,
        }
