...
from litereality_agent.pipeline.stages.author.impl import CAPABILITY_TOOLS, build_capability_server
...
def test_render_params_accept_the_targets_the_prompt_asks_for(target):
    ...
    from litereality_agent.services.tools.render.tool import RenderParams
