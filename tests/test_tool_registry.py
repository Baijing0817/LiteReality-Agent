...
from litereality_agent.realism_authoring.tools.base import BaseDeclarativeTool
from litereality_agent.realism_authoring.tools.default_registry import CAPABILITY_TOOLS
...
def test_registry_is_exactly_the_capability_tools(registry):
    ...
    from litereality_agent.realism_authoring.author import CAPABILITY_TOOLS as CAP_NAMES
